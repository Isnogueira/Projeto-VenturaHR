...
<form action="/registro" method="post">
   ...
   <br>
    ...
    <div class="container">
          ...
          <input type="number" class="form-control" placeholder="Entre com o telefone" name="telefone">
    </div>
    <br>
    <div class="container">
        ...
        <div class="container">
              ...
              <input type="number" class="form-control" placeholder="Entre com o cnpj" name="cnpj">
        </div>
        <br>
        <div class="container">
